...
import type { Genre as _Genre, Movie as _Movie, MovieId as _MovieId, UserProfile as _UserProfile, UserRole as _UserRole, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async createMovie(arg0: string, arg1: string, arg2: Genre, arg3: bigint, arg4: bigint, arg5: string): Promise<MovieId> {
        if (this.processError) {
            try {
                const result = await this.actor.createMovie(arg0, arg1, to_candid_Genre_n10(this._uploadFile, this._downloadFile, arg2), arg3, arg4, arg5);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getMovie(arg0: MovieId): Promise<Movie> {
        if (this.processError) {
            try {
                const result = await this.actor.getMovie(arg0);
                return from_candid_Movie_n13(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
            }
    ...
    async updateMovie(arg0: MovieId, arg1: string, arg2: string, arg3: Genre, arg4: bigint, arg5: bigint, arg6: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateMovie(arg0, arg1, arg2, to_candid_Genre_n10(this._uploadFile, this._downloadFile, arg3), arg4, arg5, arg6);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_Genre_n15(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _Genre): Genre {
    return from_candid_variant_n16(_uploadFile, _downloadFile, value);
}
function from_candid_Movie_n13(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _Movie): Movie {
...
function from_candid_record_n14(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        genre: from_candid_Genre_n15(_uploadFile, _downloadFile, value.genre),
...
function from_candid_variant_n16(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "action" in value ? Genre.action : "thriller" in value ? Genre.thriller : "documentary" in value ? Genre.documentary : "other" in value ? Genre.other : "animation" in value ? Genre.animation : "sciFi" in value ? Genre.sciFi : "comedy" in value ? Genre.comedy : "horror" in value ? Genre.horror : "drama" in value ? Genre.drama : "romance" in value ? Genre.romance : value;
}
...
function from_candid_vec_n12(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_Movie>): Array<Movie> {
    return value.map((x)=>from_candid_Movie_n13(_uploadFile, _downloadFile, x));
}
function to_candid_Genre_n10(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Genre): _Genre {
...
function to_candid_variant_n11(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Genre): {
    action: null;
} | {
    thriller: null;
} | {
